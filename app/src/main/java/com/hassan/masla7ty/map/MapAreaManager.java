...
public class MapAreaManager implements OnMarkerDragListener, OnMapLongClickListener {
	...
	public static LatLng currentPoint = new LatLng(50, 10);
    ...
    public void onMarkerDragStart(Marker marker) {
        ...
        switch (result.markerMoveResult) {
	        ...
	        case radiusChange: {
                //currentRadius = getCircleRadius(result.draggableCircle);
    ...
    public static double getCircleRadius(MapAreaWrapper circle) {
